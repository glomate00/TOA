...
public class MergeSortRecursive {
    ...
    public static void mergeSort(int[] arr, int left, int right, int depth) {
        if (left < right) {
            ...
            System.out.println("Глибина " + depth + ": ліва частина " + Arrays.toString(Arrays.copyOfRange(arr, left, mid + 1)));
            mergeSort(arr, left, mid, depth + 1);
            System.out.println("Глибина " + depth + ": права частина " + Arrays.toString(Arrays.copyOfRange(arr, mid + 1, right + 1)));
